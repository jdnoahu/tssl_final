...
import SpiritualityHeroImage from "../../photos/spirituality_hero.jpg";
import PillarPreviewImage from "../../photos/blog_preview.jpg";
import PillarImage from "../../photos/spirituality_page.jpg";
...
export default function Spirituality() {
    ...
    function getBlogs() {
        axios.get("http://127.0.0.1:5000/blogs",
            ...
            var filteredData = arr.filter(item => item.category === "Spirituality")
    ...
    return (
        <div className="spirituality_wrapper">
            <Navigation />
            <div className="hero_image">
                <img src={SpiritualityHeroImage} />
            </div>
            <div className="page_title">Spirituality</div>
            <div className="spirituality_pillar_color_bar"></div>

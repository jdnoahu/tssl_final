...
import HealthHeroImage from "../../photos/health_hero.jpg";
import PillarPreviewImage from "../../photos/blog_preview.jpg";
import PillarImage from "../../photos/health_page.jpg";
...
export default function Health() {
    ...
    function getBlogs() {
        axios.get("http://127.0.0.1:5000/blogs",
            ...
            var filteredData = arr.filter(item => item.category === "Health")
    ...
    return (
        <div className="health_wrapper">
            ...
            <div className="hero_image">
                <img src={HealthHeroImage} />
            </div>
            <div className="page_title">Health</div>
            <div className="health_pillar_color_bar"></div>

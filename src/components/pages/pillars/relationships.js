...
import RelationshipsHeroImage from "../../photos/relationships_hero.jpg";
import PillarPreviewImage from "../../photos/blog_preview.jpg";
import PillarImage from "../../photos/relationships_page.jpg";
...
export default function relationships() {
    ...
    function getBlogs() {
        axios.get("http://127.0.0.1:5000/blogs",
            ...
            var filteredData = arr.filter(item => item.category === "Relationships")
    ...
    return (
        <div className="relationships_wrapper">
            <Navigation />
            <div className="hero_image">
                <img src={RelationshipsHeroImage} />
            </div>
            <div className="page_title">Relationships</div>
            <div className="relationships_pillar_color_bar"></div>
